...
SubShader {
	...
	Pass {
		...
		#include "Packages/com.turnroot.framework/Core/TextMesh Pro/Shaders/TMPro_Properties.cginc"
		#include "Packages/com.turnroot.framework/Core/TextMesh Pro/Shaders/TMPro.cginc"
